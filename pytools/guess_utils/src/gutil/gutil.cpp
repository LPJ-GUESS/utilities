...
/// environment.
///
/// Enquiries to: Joe Lindstrom, Lund University: joe.lindstrom@nateko.lu.se
/// All rights reserved, copyright retained by the author.
///
/// \author Ben Smith, University of Lund
/// $Date: 2012-11-14 16:24:19 +0100 (Wed, 14 Nov 2012) $
///
///////////////////////////////////////////////////////////////////////////////////////
...
char xtring::operator==(xtring& s2) const {

	if (strcmp(ptext,s2.ptext)) return 0;
	return 1;
}

char xtring::operator==(char* s2) const {

	if (strcmp(ptext,s2)) return 0;
	return 1;
}

char xtring::operator==(const char* s2) const {

	if (strcmp(ptext,s2)) return 0;
	return 1;
}

char xtring::operator==(char c) const {
